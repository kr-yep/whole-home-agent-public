...
| `MVA-011` | perception adapter 可替換而不改 state/query semantics | `CandidateProducer` contract | canonical schema | contract mismatch fail | scripted/recorded adapter contract suite | `PROPOSED; NOT IMPLEMENTED` |
